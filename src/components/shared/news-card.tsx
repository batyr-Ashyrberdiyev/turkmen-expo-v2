...
export const NewsCard: FC<Props> = ({ className, id }) => {
  return (
    <Link to={`/news/${id}`}>
      <article className={cn(className, 'bg-SURFACE_CONTAINER border border-CONTAINER_OUTLINE')}>
        <div className="h-[182px] w-[298px]">
          <img src="/news-img.png" alt="news" className="size-full object-cover" />
        </div>
