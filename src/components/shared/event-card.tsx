...
export const EventCard: FC<Props> = ({ className }) => {
  return (
    <article
      className={cn(
        className,
        "p-4 bg-SURFACE_CONTAINER border border-CONTAINER_OUTLINE rounded-[4px] flex  gap-8"
      )}
    >
      <div>
      ...
      <div className="flex-auto">
        <h3 className="h3 !text-ON_SURFACE mb-4">
          Выставка-ярмарка KIDS EXPO TURKMENISTAN
        </h3>
